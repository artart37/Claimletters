...
handler(e:any){
    ...
    e.hasOwnProperty('nosigninheader')?this.headersigninsignup = false:this.headersigninsignup = true;
    //Check if the router outlet has a property named perfectmiddle, then assign true to the centralised property within afterviewinit
    ...
    e.hasOwnProperty('perfectcentre')?this.centralized = true:this.centralized = false
  };
}